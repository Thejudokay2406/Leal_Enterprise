    ...
    public class Conexion_Marca
    {
        public DataTable Lista()
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("Consulta.Marca", SqlCon);
        ...
        public string Guardar_DatosBasicos(Entidad_Marca Obj)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public string Editar_DatosBasicos(Entidad_Marca Obj)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public string Eliminar(int IDEliminar_Sql, int Auto)
        {
            ...
            try
            {
                ...
                //Panel Datos Basicos
                Comando.Parameters.Add("@Auto", SqlDbType.Int).Value = Auto;
                Comando.Parameters.Add("@Idmarca", SqlDbType.Int).Value = IDEliminar_Sql;
