    ...
    public class Conexion_TipoDeProducto
    {
        public DataTable Lista(int Auto)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("Productos.LI_Tipo", SqlCon);
        ...
        public string Guardar_DatosBasicos(Entidad_TipoDeProducto Obj)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public string Editar_DatosBasicos(Entidad_TipoDeProducto Obj)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public string Eliminar(int IDEliminar_Sql, int Auto)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add("@Idtipo", SqlDbType.Int).Value = IDEliminar_Sql;
