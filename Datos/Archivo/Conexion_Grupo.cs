    ...
    public class Conexion_Grupo
    {
        public DataTable Lista()
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("Consulta.Grupo", SqlCon);
        ...
        public string Guardar_DatosBasicos(Entidad_Grupo Obj)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        public string Editar_DatosBasicos(Entidad_Grupo Obj)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
