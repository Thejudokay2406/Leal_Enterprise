    ...
    public class Conexion_Servicios
    {
        public DataTable AutoIncrementable(int Auto)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("Archivo.LI_Servicio", SqlCon);
        ...
        public string Guardar_DatosBasicos(Entidad_Servicio Obj)
        {
            ...
            try
            {
                ...
                //Datos Auxiliares y Llaves Primarias Auxiliares
                ...
                Comando.Parameters.Add("@Costo", SqlDbType.Money).Value = Obj.Costo;
                Comando.Parameters.Add("@Valor01", SqlDbType.Money).Value = Obj.Valor01;
                Comando.Parameters.Add("@Valor02", SqlDbType.Money).Value = Obj.Valor02;
                Comando.Parameters.Add("@Valor03", SqlDbType.Money).Value = Obj.Valor03;
                Comando.Parameters.Add("@Utilidad", SqlDbType.BigInt).Value = Obj.Utilidad;
                Comando.Parameters.Add("@Ejecucion", SqlDbType.BigInt).Value = Obj.Ejecucion;
