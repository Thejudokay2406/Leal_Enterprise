...
{
    public partial class frmCliente_Grupo : Form
    {
        ...
        public frmCliente_Grupo()
        {
            InitializeComponent();
        }

        private void frmCliente_Grupo_Load(object sender, EventArgs e)
        {
        ...
        private void frmCliente_Grupo_Activated(object sender, EventArgs e)
        {
            this.TBGrupo.Focus();
        }
